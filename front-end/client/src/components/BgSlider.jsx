...
const BgSlider = () => {
    ...
    return (
        <div className="mb-16 relative">
            ...
            {/* Category Selector */}
            <div className="flex justify-start md:justify-center mb-10 overflow-x-auto no-scrollbar w-full px-4 md:px-0">
                <div className="inline-flex gap-4 bg-gray-100 rounded-full p-2 whitespace-nowrap">
